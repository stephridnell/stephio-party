<template>
  <div class="card-wrapper mb-26">
    <div class="card" :class="{ 'greyscale': (team && !connectedUsers.includes(team.userId)) || (!teamsTurn && gameStarted) }" :style="'background:linear-gradient(180deg, var(--player' + index + ') 0%, var(--player' + index + 'darker) 100%);box-shadow: 0 12px 0px 0px var(--player' + index + 'darkest)'">
