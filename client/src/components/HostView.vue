  ...
  <div class="host-view">
    <div class="container p-30">
      <div class="box" v-for="(team, index) in maxTeams" :key="index" style="border-radius:64px;box-shadow: rgb(0 0 0 / 35%) 0px 0px 18px 0px;">
        <div class="card mb-26" :style="'background:var(--player' + index + ');box-shadow: 0 12px 0px 0px var(--player' + index + 'darker)'">
          <div class="p-20 card-body" v-if="currentTeams[index]">
            ...
            <div class="text-32 text-bold text-caps" v-if="!connectedUsers.includes(currentTeams[index].userId)">
              Offline
            </div>
          </div>
